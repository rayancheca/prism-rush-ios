...
/// real authored hexes — no skin EVER follows the world palette (owner decree 1), and no skin
/// changes colour over TIME either: v1.8 removed Prism's 8 s hue shimmer on the owner's call —
/// "why does the character change colours as it runs, that defeats the whole purpose of having
/// different characters". A character is one identity, everywhere, always.
